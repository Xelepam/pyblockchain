...
# Example of a request for a transaction a user would send to the server
"""
{
    "sender": "my address",
...
class Blockchain(object):
    ...
    def register_node(self, address):
        """
        Add a new nodd to the list of nodes
    ...
    def resolve_conflicts(self):
        ...
        # Grab and verify the chains longer than our 
...
def new_transaction():
    ...
    # Check that the requred field are in the POSTed data
